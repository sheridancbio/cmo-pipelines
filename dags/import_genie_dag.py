...
with DAG(
    ...
    params={
        ...
        "data_repos": Param("genie", type="string", title="Data Repositories", description="Comma-separated list of data repositories to pull updates from/cleanup. Accepted values: ['genie', 'dmp']")
    }
) as dag:
