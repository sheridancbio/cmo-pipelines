 ...
 * @author heinsz
 */
public class MelanomaTimelineRadTherapy implements MelanomaTimelineRecord {
    ...
    public MelanomaTimelineRadTherapy() {}

    public MelanomaTimelineRadTherapy(String melrtPtid,
