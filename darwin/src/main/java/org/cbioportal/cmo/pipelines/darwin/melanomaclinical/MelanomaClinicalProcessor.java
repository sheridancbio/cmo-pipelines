 ...
 * @author heinsz
 */
public class MelanomaClinicalProcessor implements ItemProcessor<MelanomaClinicalRecord, String> {
    
    @Override
    public String process(final MelanomaClinicalRecord melanomaClinicalRecord) throws Exception{
