...
import org.cbioportal.cmo.pipelines.darwin.model.MelanomaTimelineAdjuvantTx;
 ...
 * @author heinsz
 */
public class MelanomaTimelineWriter implements ItemStreamWriter<String> {
    
    @Value("#{jobParameters[stagingDirectory]}")
    private String stagingDirectory;
    
    @Value("${darwin.melanoma_timeline_filename}")
    ...
    public void open(ExecutionContext executionContext) throws ItemStreamException {
        ...
        flatFileItemWriter.setHeaderCallback(new FlatFileHeaderCallback(){
            ...
            public void writeHeader(Writer writer) throws IOException {
                writer.write(StringUtils.join(new MelanomaTimelineAdjuvantTx().getFieldNames(), "\t"));
            }
        });
