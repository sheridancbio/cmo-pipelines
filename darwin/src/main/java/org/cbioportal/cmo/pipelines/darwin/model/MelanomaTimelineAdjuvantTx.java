 ...
 * @author heinsz
 */
public class MelanomaTimelineAdjuvantTx implements MelanomaTimelineRecord { 
    ...
    public MelanomaTimelineAdjuvantTx() {}
    
    public MelanomaTimelineAdjuvantTx(String melatPtid, 
