...
import org.cbioportal.cmo.pipelines.darwin.model.MelanomaTimelineRecord;
 ...
 * @author heinsz
 */
public class MelanomaTimelineProcessor implements ItemProcessor<MelanomaTimelineRecord, String> {
    
    @Override
    public String process(final MelanomaTimelineRecord melanomaTimelineRecord) throws Exception{
