 ...
 * @author heinsz
 */
public class MelanomaClinicalRecord {
    
    private String patientId;
    private String sampleId;
    private String melspcPtid;
    private Integer  melspcStageYear;
    ...
    private Integer melgPresStgYear;
    private String melgFamilyHxDesc;
    private Integer melg1stRecurYear;
    ...
    private Integer melgRecurNodalNo;
    private Integer melgLdh;
    private Integer melgLdhYear;
    ...
    private Integer melpPrimSeq;
    private Integer melpDxYear;
    private String melpMskReviewDesc;
    private float melpThicknessMm;
    ...
    private Integer meliReportYear;
    private Integer meliProcedureYear;
    ...
    public MelanomaClinicalRecord() {}
    
    public MelanomaClinicalRecord(String melspcPtid,
            Integer  melspcStageYear,
            ...
            Integer meliReportYear,
            Integer meliProcedureYear,
            String meliTumorType,
            String meliPrimarySite,
            String meliMetSite) {
this.melspcPtid = StringUtils.isNotEmpty(melspcPtid) ? melspcPtid : "NA";
this.melspcStageYear = melspcStageYear != null ? melspcStageYear : -1;
...
this.melgPresStgYear = melgPresStgYear != null ? melgPresStgYear : -1;
this.melgFamilyHxDesc = StringUtils.isNotEmpty(melgFamilyHxDesc) ? melgFamilyHxDesc : "NA";
this.melg1stRecurYear = melg1stRecurYear != null ? melg1stRecurYear : -1;
...
this.melgRecurNodalNo = melgRecurNodalNo != null ? melgRecurNodalNo : -1;
this.melgLdh = melgLdh != null ? melgLdh : -1;
this.melgLdhYear = melgLdhYear != null ? melgLdhYear : -1;
...
this.melpPrimSeq = melpPrimSeq != null ? melpPrimSeq : -1;
this.melpDxYear = melpDxYear != null ? melpDxYear : -1;
this.melpMskReviewDesc = StringUtils.isNotEmpty(melpMskReviewDesc) ? melpMskReviewDesc : "NA";
this.melpThicknessMm = melpThicknessMm != null ? melpThicknessMm : -1;
...
this.melpLnsentinbxYear = melpLnsentinbxYear != null ? melpLnsentinbxYear : -1;
...
this.melpLndsctYear = melpLndsctYear != null ? melpLndsctYear : -1;
...
this.melpLnsize = melpLnsize != null ? melpLnsize : -1;
this.melpLnsizeUnkDesc = StringUtils.isNotEmpty(melpLnsizeUnkDesc) ? melpLnsizeUnkDesc : "NA";
this.melpLnslnlargSize = melpLnslnlargSize != null ? melpLnslnlargSize : -1;
...
this.meliReportYear = meliReportYear != null ? meliReportYear : -1;
this.meliProcedureYear = meliProcedureYear != null ? meliProcedureYear : -1;
...
this.meliMetSite = StringUtils.isNotEmpty(meliMetSite) ? meliMetSite : "NA";
    ...
    public Integer getMELSPC_STAGE_YEAR() {
        return melspcStageYear;
    }
    
    public void setMELSPC_STAGE_YEAR(Integer melspcStageYear) {
    ...
    public Integer getMELG_PRES_STG_YEAR() {
        return melgPresStgYear;
    }
    
    public void setMELG_PRES_STG_YEAR(Integer melgPresStgYear) {
    ...
    public Integer getMELG_1ST_RECUR_YEAR() {
        return melg1stRecurYear;
    }
    
    public void setMELG_1ST_RECUR_YEAR(Integer melg1stRecurYear) {
    ...
    public Integer getMELG_RECUR_NODAL_NO() {
        return melgRecurNodalNo;
    }
    
    public void setMELG_RECUR_NODAL_NO(Integer melgRecurNodalNo) {
        this.melgRecurNodalNo = melgRecurNodalNo;
    }  

    public Integer getMELG_LDH() {
        return melgLdh;
    }
    
    public void setMELG_LDH(Integer melgLdh) {
        this.melgLdh = melgLdh;
    }

    public Integer getMELG_LDH_YEAR() {
        return melgLdhYear;
    }
    
    public void setMELG_LDH_YEAR(Integer melgLdhYear) {
    ...
    public Integer getMELP_PRIM_SEQ() {
        return melpPrimSeq;
    }
    
    public void setMELP_PRIM_SEQ(Integer melpPrimSeq) {
        this.melpPrimSeq = melpPrimSeq;
    }
    
    public Integer getMELP_DX_YEAR() {
        return melpDxYear;
    }
    
    public void setMELP_DX_YEAR(Integer melpDxYear) {
    ...
    public float getMELP_THICKNESS_MM() {
        return melpThicknessMm;
    }
    
    public void setMELP_THICKNESS_MM(float melpThicknessMm) {
    ...
    public Integer getMELP_LNSENTINBX_YEAR() {
        return melpLnsentinbxYear;
    }
    
    public void setMELP_LNSENTINBX_YEAR(Integer melpLnsentinbxYear) {
    ...
    public Integer getMELP_LNDSCT_YEAR() {
        return melpLndsctYear;
    }
    
    public void setMELP_LNDSCT_YEAR(Integer melpLndsctYear) {
    ...
    public float getMELP_LNSIZE() {
        return melpLnsize;
    }
    
    public void setMELP_LNSIZE(float melpLnsize) {
    ...
    public float getMELP_LNSLNLARG_SIZE() {
        return melpLnslnlargSize;
    }
    
    public void setMELP_LNSLNLARG_SIZE(float melpLnslnlargSize) {
    ...
    public Integer getMELI_REPORT_YEAR() {
        return meliReportYear;
    }
    
    public void getMELI_REPORT_YEAR(Integer meliReportYear) {
        this.meliReportYear = meliReportYear;
    }    

    public Integer getMELI_PROCEDURE_YEAR() {
        return meliProcedureYear;
    }
    
    public void setMELI_PROCEDURE_YEAR(Integer meliProcedureYear) {
