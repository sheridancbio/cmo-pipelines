...
public class DarwinPatientDemographics {
    ...
    public DarwinPatientDemographics withPT_ID_DEMO(String PT_ID_DEMO) {
        this.PT_ID_DEMO = PT_ID_DEMO;
        return this;
    }

    public DarwinPatientDemographics withDMP_ID_DEMO(String DMP_ID_DEMO) {
        this.DMP_ID_DEMO = DMP_ID_DEMO;
        return this;
    }

    public DarwinPatientDemographics withGENDER(String GENDER) {
        this.GENDER = GENDER;
        return this;
    }

    public DarwinPatientDemographics withRACE(String RACE) {
        this.RACE = RACE;
        return this;
    }

    public DarwinPatientDemographics withRELIGION(String RELIGION) {
        this.RELIGION = RELIGION;
        return this;
    }

    public DarwinPatientDemographics withAGE_AT_DATE_OF_DEATH_IN_DAYS(String AGE_AT_DATE_OF_DEATH_IN_DAYS) {
        this.AGE_AT_DATE_OF_DEATH_IN_DAYS = AGE_AT_DATE_OF_DEATH_IN_DAYS;
        return this;
    }

    public DarwinPatientDemographics withDEATH_SOURCE_DESCRIPTION(String DEATH_SOURCE_DESCRIPTION) {
        this.DEATH_SOURCE_DESCRIPTION = DEATH_SOURCE_DESCRIPTION;
        return this;
    }
    
    public DarwinPatientDemographics withVITAL_STATUS(String VITAL_STATUS) {
        this.VITAL_STATUS = VITAL_STATUS;
        return this;
    }

    public DarwinPatientDemographics withPT_COUNTRY(String PT_COUNTRY) {
        this.PT_COUNTRY = PT_COUNTRY;
        return this;
    }

    public DarwinPatientDemographics withPT_STATE(String PT_STATE) {
        this.PT_STATE = PT_STATE;
        return this;
    }

    public DarwinPatientDemographics withPT_ZIP3_CD(String PT_ZIP3_CD) {
        this.PT_ZIP3_CD = PT_ZIP3_CD;
        return this;
    }

    public DarwinPatientDemographics withPT_BIRTH_YEAR(String PT_BIRTH_YEAR) {
        this.PT_BIRTH_YEAR = PT_BIRTH_YEAR;
        return this;
    }

    public DarwinPatientDemographics withPT_SEX_DESC(String PT_SEX_DESC) {
        this.PT_SEX_DESC = PT_SEX_DESC;
        return this;
    }

    public DarwinPatientDemographics withPT_VITAL_STATUS(String PT_VITAL_STATUS) {
        this.PT_VITAL_STATUS = PT_VITAL_STATUS;
        return this;
    }

    public DarwinPatientDemographics withPT_MARITAL_STS_DESC(String PT_MARITAL_STS_DESC) {
        this.PT_MARITAL_STS_DESC = PT_MARITAL_STS_DESC;
        return this;
    }

    public DarwinPatientDemographics withPT_DEATH_YEAR(String PT_DEATH_YEAR) {
        this.PT_DEATH_YEAR = PT_DEATH_YEAR;
        return this;
    }

    public DarwinPatientDemographics withPT_MRN_CREATE_YEAR(String PT_MRN_CREATE_YEAR) {
