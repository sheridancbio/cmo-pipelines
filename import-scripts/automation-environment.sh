...
export MSK_TAILORMEDJAPAN_DATA_HOME=$PORTAL_DATA_HOME/dmp/msk_tailormedjapan
...
export MSK_TAILORMEDJAPAN_IMPORT_TRIGGER=$MSK_DMP_TMPDIR/msk_tailormedjapan_import_trigger.txt
