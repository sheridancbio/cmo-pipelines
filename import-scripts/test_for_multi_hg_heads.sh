...
HG_SUB_REPO_LIST=". bic-mouse bic-mskcc brlo_tcga gdac_provisional_tcga genie grail immunotherapy impact levine_mskcc dmp portal-configuration private rudin_mskcc solit_mskcc ucec_tcga yale_brain_tumor dm"
HG_ERROR_CODE=1
