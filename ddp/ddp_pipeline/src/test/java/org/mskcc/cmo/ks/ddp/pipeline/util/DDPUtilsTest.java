...
public class DDPUtilsTest {
    ...
    * If either date is invalid, a ParseException will be thrown.
    * If either date is null, null will be returned.
    * If patientBirthDate and sampleSeqDate are both valid/not-null dates, the difference in years between the two dates will be returned.
    */
