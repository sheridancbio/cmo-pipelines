...
* CVR clinical and genomic (somatic) files:
    ...
    * `$MSK_IMPACT_DATA_HOME/data_mutations_unfiltered.txt`
...
* CVR clinical and genomic (somatic) files:
    ...
    * `$MSK_HEMEPACT_DATA_HOME/data_mutations_unfiltered.txt`
...
* CVR clinical and genomic (somatic) files:
    ...
    * `$MSK_RAINDANCE_DATA_HOME/data_mutations_unfiltered.txt`
...
* CVR clinical and genomic (somatic) files:
    ...
    * `$MSK_ACCESS_DATA_HOME/data_mutations_unfiltered.txt`
...
* Modified files:
    * MIXEDPACT Merge:
        ...
        * `$MSK_MIXEDPACT_DATA_HOME/data_mutations_unfiltered.txt`
    ...
    * MSKSOLIDHEME Merge:
        ...
        * `$MSK_SOLID_HEME_DATA_HOME/data_mutations_unfiltered.txt`
