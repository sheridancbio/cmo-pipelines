...
package org.mskcc.cmo.ks.gene.util;
...
public class GeneDataUtil {
    ...
    @Bean(name="entrezGeneIdMap")
    public Map<Integer, Gene> entrezGeneIdMap() {
        Map<Integer, Gene> entrezGeneIdMap = new HashMap<>();
        for (Gene gene : daoGeneJdbcImpl.getAllGenes()) {
