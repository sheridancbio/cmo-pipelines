...
*/
package org.cbioportal.cmo.clinical.data.source;
...
public interface ClinicalDataSource {       
    ...
    Map<String, List<String>> getSampleHeader();
    
    Map<String, List<String>> getPatientHeader();      
    
    Map<String, List<String>> getTimelineHeader();
