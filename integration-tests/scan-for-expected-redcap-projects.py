...
def get_observed_project_mapping(stable_id_list, temporary_directory_name, redcap_jar):
    mapping = {}
    for stable_id in stable_id_list:
        ...
        command = 'java -jar ' + redcap_jar + ' --export-mode --raw-data --stable-id ' + stable_id + ' --directory ' + study_tempdir_name
...
def main():
    ...
    observed_project_mapping = get_observed_project_mapping(expected_project_mapping.keys(), temporary_directory_name, redcap_jar)
